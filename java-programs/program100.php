...
<body>
    <div class="container">
        ...
        <div class="main">
            <h1>Write a Java Program to Sort the Array in an Ascending Order</h1>
            <div class="code">
                <h3>Code:-</h3>
                <p>import java.util.Arrays;<br>
                import java.util.Scanner;<br>
                public class AscendingOrderArray{<br>
                    <span>public static void main(String[] args) {</span><br>
                        ...
                        <span><span>System.out.println("Sorted Array in Ascending Order: " + Arrays.toString(array));</span></span><br>
                    <span>}</span><br>
                }</p>
            </div>
            <div class="output">
                ...
                Element 4: 6<br>
                Element 5: 5<br>
                Sorted Array in Ascending Order: [5, 6, 7, 8, 9]</p>
            </div>
        </div>
    </div>
</body>
